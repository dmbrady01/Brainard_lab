...
if strcmpi(input(['Is this the path for computer: ' '/bluejay' num2str(which_computer) '/dbrady/  '],'s'),'y') == 1
    parameters.computer = ['/bluejay' num2str(which_computer) '/dbrady/'];
else
    parameters.computer = input('What is the path for computer? ','s');
end
...
% parameters.directory_list = dir([parameters.computer parameters.birdname '/all_days_sequence/' parameters.birdname '_' parameters.con_or_div '*']);
% 
% %list the dates of the experiment and puts them in chronological order
% for i = 1:length(parameters.directory_list)
%     parameters.dates(i,:) = parameters.directory_list(i).name(end-12:end-4);
% end
% parameters.dates = sort(datenum(parameters.dates));
% parameters.dates = datestr(parameters.dates, 'ddmmmyyyy');
% 
% for i = 1:size(parameters.dates,1)
%     parameters.file_names(i,:) = [parameters.birdname '_' parameters.con_or_div '_' parameters.dates(i,:) '.mat'];
% end

fid = fopen([parameters.computer parameters.birdname '/all_days_sequence_' parameters.phrase '/' parameters.con_or_div],'r');
...
for i = 1:size(parameters.file_names,1)
    load([parameters.computer parameters.birdname '/all_days_sequence_' parameters.phrase '/' parameters.file_names(i,:)])
...
if isempty(strfind(parameters.computer,'all_sequence')) == 1
    if exist([parameters.computer 'all_sequence/'], 'dir') ~= 7
        mkdir([parameters.computer 'all_sequence/'])
    else
    end
    
    if exist([parameters.computer 'all_sequence/' parameters.birdname '_' parameters.phrase], 'dir') ~= 7
        mkdir([parameters.computer 'all_sequence/' parameters.birdname '_' parameters.phrase])
    else
    end
    
    save([parameters.computer 'all_sequence/' parameters.birdname '_' parameters.phrase '/' parameters.birdname '_' parameters.con_or_div])
    
    saveas(figure(1), [parameters.computer 'all_sequence/' parameters.birdname '_' parameters.phrase '/Transition_probabilities_for_'...
        parameters.birdname '_' parameters.con_or_div '_over_time'], 'fig')
    saveas(figure(2), [parameters.computer 'all_sequence/' parameters.birdname '_' parameters.phrase '/SD_of_transition_probabilities_for_'...
        parameters.birdname '_' parameters.con_or_div '_over_time'], 'fig')
    ...
    saveas(figure(3), [parameters.computer 'all_sequence/' parameters.birdname '_' parameters.phrase '/Entropy_for_'...
        parameters.birdname '_' parameters.con_or_div '_over_time'], 'fig')
    saveas(figure(4), [parameters.computer 'all_sequence/' parameters.birdname '_' parameters.phrase '/History_depedence_for_'...
        parameters.birdname '_' parameters.con_or_div '_over_time'], 'fig')
    saveas(figure(5), [parameters.computer 'all_sequence/' parameters.birdname '_' parameters.phrase '/Trans_prob_vs_hist_dep_for_'...
        parameters.birdname '_' parameters.con_or_div '_over_time'], 'fig')
    saveas(figure(6), [parameters.computer 'all_sequence/' parameters.birdname '_' parameters.phrase '/Ent_vs_hist_dep_for_'...
        parameters.birdname '_' parameters.con_or_div '_over_time'], 'fig')
else
   save([parameters.computer parameters.birdname '/' parameters.birdname '_' parameters.con_or_div]) 
   
   saveas(figure(1), [parameters.computer parameters.birdname '_' parameters.phrase '/Transition_probabilities_for_'...
        parameters.birdname '_' parameters.con_or_div '_over_time'], 'fig')
    saveas(figure(2), [parameters.computer parameters.birdname '_' parameters.phrase '/SD_of_transition_probabilities_for_'...
        parameters.birdname '_' parameters.con_or_div '_over_time'], 'fig')
    % saveas(figure(3), [parameters.computer parameters.birdname...
    %     '/all_days_sequence/CV_of_Transition_probabilities_for_' parameters.birdname '_' parameters.con_or_div '_over_time'], 'fig')
    saveas(figure(3), [parameters.computer parameters.birdname '_' parameters.phrase '/Entropy_for_'...
        parameters.birdname '_' parameters.con_or_div '_over_time'], 'fig')
    saveas(figure(4), [parameters.computer parameters.birdname '_' parameters.phrase '/History_depedence_for_'...
        parameters.birdname '_' parameters.con_or_div '_over_time'], 'fig')
    saveas(figure(5), [parameters.computer parameters.birdname '_' parameters.phrase '/Trans_prob_vs_hist_dep_for_'...
        parameters.birdname '_' parameters.con_or_div '_over_time'], 'fig')
    saveas(figure(6), [parameters.computer parameters.birdname '_' parameters.phrase '/Ent_vs_hist_dep_for_'...
        parameters.birdname '_' parameters.con_or_div '_over_time'], 'fig')
end
