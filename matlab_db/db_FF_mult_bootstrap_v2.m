...
mult_FF_boot.parameters.computer = ['/bluejay' num2str(which_computer) '/dbrady/all_calls_analysis_pitch/'];
...
% mult_FF_boot.parameters.shift_direction = input('Shift down or up?  ', 's');
% if strcmpi(mult_FF_boot.parameters.shift_direction,'up')
%     mult_FF_boot.parameters.max_or_min = @max;
% elseif strcmpi(mult_FF_boot.parameters.shift_direction,'down')
%     mult_FF_boot.parameters.max_or_min = @min;
% else
%     mult_FF_boot.parameters.shift_direction = input('Sorry, I did not get that. Shift down or up?  ', 's');
% end

fprintf('\nLoading data...')

try
    load([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname '_' mult_FF_boot.parameters.phrase '/' mult_FF_boot.parameters.birdname '.mat'])
catch err
...
if exist([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname '_' mult_FF_boot.parameters.phrase '/bootstrap_figures'], 'dir') ~= 7
    mkdir([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname '_' mult_FF_boot.parameters.phrase '/bootstrap_figures'])
else
end
...
%             'LineStyle', '--', 'Color', [0 0 0])
        ...
        %save figures
        saveas(figure(gcf),[mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
            mult_FF_boot.parameters.birdname '_' mult_FF_boot.parameters.phrase '/bootstrap_figures/' ...
...
if exist([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname '_' mult_FF_boot.parameters.phrase '/percent_change_figures'], 'dir') ~= 7
    mkdir([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname '_' mult_FF_boot.parameters.phrase '/percent_change_figures'])
else
end
...
for i = 1:length(multiple_pitch.parameters.syllables)
    for j = 1:length(mult_FF_boot.parameters.names_parameters)
        ...
        %save figures
        saveas(figure(gcf),[mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
            mult_FF_boot.parameters.birdname '_' mult_FF_boot.parameters.phrase '/percent_change_figures/Percent_change_' ...
            strrep(mult_FF_boot.parameters.names_parameters{j},' ','_') '_for_' multiple_pitch.parameters.syllables(i) ...
            '_for_' mult_FF_boot.parameters.birdname], 'fig')
    end
end
...
if exist([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname '_' mult_FF_boot.parameters.phrase '/change_from_baseline_figures'], 'dir') ~= 7
    mkdir([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname '_' mult_FF_boot.parameters.phrase '/change_from_baseline_figures'])
else
end
...
for i = 1:length(multiple_pitch.parameters.syllables)
    for j = 1:length(mult_FF_boot.parameters.names_parameters)
        ...
        %save figures
        saveas(figure(gcf),[mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
            mult_FF_boot.parameters.birdname '_' mult_FF_boot.parameters.phrase ...
...
if exist([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname '_' mult_FF_boot.parameters.phrase  '/correlation_figures'], 'dir') ~= 7
    mkdir([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname '_' mult_FF_boot.parameters.phrase '/correlation_figures'])
else
end
...
%            temp_cell_index-1-multiple_pitch.parameters.duration.begin)
   ...
   for j = 1:length(mult_FF_boot.(multiple_pitch.parameters.syllables(i)).calculations.cell_to_mat.cell_to_mat)
...
if exist([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname '_' mult_FF_boot.parameters.phrase '/z_score_figures'], 'dir') ~= 7
    mkdir([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
        mult_FF_boot.parameters.birdname  '_' mult_FF_boot.parameters.phrase '/z_score_figures'])
else
end
...
save([mult_FF_boot.parameters.computer multiple_pitch.parameters.experiment_type...
    mult_FF_boot.parameters.birdname '_' mult_FF_boot.parameters.phrase ...
